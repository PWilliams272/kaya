...
const V2_SYMBOLS = [
  ...
  ['\\(\\gamma_1\\)', 'how much ability changes per SD of height, for a <b>male-coded</b> climber (the baseline)', 'grades / SD'],
  ['\\(\\gamma_2\\)', 'curvature of that height effect for a male-coded climber &mdash; negative bends downward at the extremes', 'grades / SD²'],
  ['\\(\\gamma_1^{\\times}\\)', '<b>extra</b> height slope for a female-coded climber, added on top of \\(\\gamma_1\\). Female slope = \\(\\gamma_1+\\gamma_1^{\\times}\\)', 'grades / SD'],
  ['\\(\\gamma_2^{\\times}\\)', '<b>extra</b> curvature for a female-coded climber. Female curvature = \\(\\gamma_2+\\gamma_2^{\\times}\\)', 'grades / SD²'],
...
const V2_FORMS = [
  ...
  ['Quadratic &times; gender', '\\(+\\,G(\\gamma_1^{\\times}\\tilde h+\\gamma_2^{\\times}\\tilde h^2)\\)', 'Height works <i>differently</i> for men and women &mdash; separate curve for each. <b>This is what v1 concluded.</b>', '4'],
